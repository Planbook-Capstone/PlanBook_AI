...
async def _process_cv_async(task_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        await mongodb_task_service.update_task_progress(task_id, 20, "Processing CV with OCR...")
        ...
        await mongodb_task_service.update_task_progress(task_id, 80, "CV processing completed")
